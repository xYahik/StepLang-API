...
import com.example.steplang.dtos.quest.QuestData_SpendTimeLearningDTO;
...
public interface QuestMapper {
    ...
    @SubclassMapping(source = QuestData_SpendTimeLearning.class, target = QuestData_SpendTimeLearningDTO.class)
